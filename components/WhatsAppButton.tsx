...
export function WhatsAppButton({
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#25D366] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#1ebe57] md:w-auto"
    >
